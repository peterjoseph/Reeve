...
module.exports = function(router) {
	...
	router.get(
		"/internal/validate_workspace_url/",
		restrict({
			loggedIn: true,
			notLoggedIn: true
		}),
	...
	router.post(
		"/internal/forgot_account_details/",
		restrict({
			notLoggedIn: true
		}),
		function(req, res, next) {
	...
	router.get(
		"/internal/validate_reset_password_code/",
		restrict({
			notLoggedIn: true
		}),
		function(req, res, next) {
